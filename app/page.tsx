...
import { Wrench, Building2, Clock, Shield } from 'lucide-react';
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-1 text-xs text-gray-500 font-medium">
              <span className="flex items-center gap-1">
                <Shield className="w-3.5 h-3.5 text-[#FE5000]" /> Role: <strong className="uppercase text-gray-700">{user?.role || 'User'}</strong>
              </span>
              <span>•</span>
